...
**ApplyHub** is a web-based job portal system designed to seamlessly connect job seekers and employers on a single, unified platform. The system automates the recruitment lifecycle through three distinct user layers:
* **Applicants**: Can effortlessly browse job listings, submit and track applications, and manage their professional profiles.
* **Employers**: Can post job opportunities, manage listings, and review incoming applications through a dedicated dashboard.
* **Administrators**: Maintain system integrity by moderating and approving job postings prior to publication.
